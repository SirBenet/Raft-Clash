...
playsound block.note.pling master @s[nbt={Inventory:[{id:"minecraft:acacia_fence_gate"}]}] ~ ~ ~ 1 0.9
playsound block.note.pling master @s[nbt={Inventory:[{id:"minecraft:birch_fence_gate"}]}] ~ ~ ~ 1 0.9