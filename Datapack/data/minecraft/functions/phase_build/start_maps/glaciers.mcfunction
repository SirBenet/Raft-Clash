...
setblock 3312 28 -304 structure_block[mode=load]{mode:"LOAD",name:"arena_loader",integrity:1.0f} replace
...
execute if entity @s[tag=!GlaciersReady] run scoreboard players set LOAD Timer 0
