...
execute if entity @s[tag=AIModeAttack] unless entity @p[distance=..8] run function ai/enter_control_mode
execute if entity @s[tag=AIModeControl] if entity @p[distance=..8] run function ai/enter_attack_mode