...
execute if score Tip Timer matches 600.. as 0-0-0-0-1 if entity @s[name=PhaseBuild] run function code/tips_build
execute if score Tip Timer matches 600.. as 0-0-0-0-1 if entity @s[name=PhasePlay] run function code/tips_play
