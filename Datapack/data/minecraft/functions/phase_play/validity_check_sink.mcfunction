...
execute if entity @s[scores={RaftID=1..},tag=RAFTChestSank] run replaceitem entity @a[scores={RaftID=0}] weapon.offhand air 
execute if entity @s[scores={RaftID=1..},tag=RAFTChestSank] run scoreboard players operation @a RaftID += @s RaftID
...
execute if entity @s[scores={RaftID=-1},tag=RAFTChestSank] run replaceitem entity @a[team=blue] weapon.offhand air 
...
execute if entity @s[scores={RaftID=-2},tag=RAFTChestSank] run replaceitem entity @a[team=red] weapon.offhand air 
...
execute if entity @s[scores={RaftID=-3},tag=RAFTChestSank] run replaceitem entity @a[team=green] weapon.offhand air 
...
execute if entity @s[scores={RaftID=-4},tag=RAFTChestSank] run replaceitem entity @a[team=yellow] weapon.offhand air 
...
execute if entity @s[scores={RaftID=-6},tag=RAFTChestSank] run replaceitem entity @a weapon.offhand air 
