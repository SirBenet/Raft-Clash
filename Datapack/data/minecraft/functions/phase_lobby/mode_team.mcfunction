...
setblock ~ ~1 ~ air
setblock ~ ~ ~ air
setblock ~ ~ ~ oak_wall_sign[facing=north]{Text1:"{\"text\":\"\",\"clickEvent\":{\"action\":\"run_command\",\"value\":\"function phase_lobby/mode_ffa\"}}",Text2:"[\"\",{\"text\":\"\\u2620 \"},{\"text\":\"T\",\"bold\":true,\"color\":\"dark_aqua\"},{\"text\":\"E\",\"bold\":true,\"color\":\"dark_red\"},{\"text\":\"A\",\"bold\":true,\"color\":\"dark_green\"},{\"text\":\"M \",\"bold\":true,\"color\":\"gold\"},{\"text\":\"\\u2620\"}]",Text3:"{\"text\":\"[Change to FFA]\",\"color\":\"dark_gray\"}"}
