...
data merge block ~ ~ ~ {Text1:"{\"text\":\"\",\"clickEvent\":{\"action\":\"run_command\",\"value\":\"function phase_lobby/mode_team\"}}",Text2:"[\"\",{\"text\":\"\\u2620 \"},{\"text\":\"AI boss\",\"bold\":true,\"color\":\"black\"},{\"text\":\" \",\"bold\":true,\"color\":\"gold\"},{\"text\":\"\\u2620\"}]",Text3:"{\"text\":\"[Change to TEAM]\",\"color\":\"dark_gray\"}"}
